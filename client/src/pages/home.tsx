  ...
  const topCaptains = [
    {
      ...
      speciality: "Deep Sea Marlin",
      rating: 4.9,
      trips: 847,
      image: "/attached_assets/image_1749589187411.png",
      badge: "Top Rated",
    },
    {
      id: 2,
      ...
      speciality: "Reef & Wreck Fishing",
      rating: 4.8,
      trips: 623,
      image: "/attached_assets/image_1749589049214.png",
      badge: "Most Booked",
    },
    {
      id: 3,
      name: "Captain Paolo Rossi",
      location: "Amalfi Coast, Italy",
      speciality: "Mediterranean Tuna",
      rating: 4.9,
      trips: 445,
      image: "/attached_assets/image_1749589265116.png",
      badge: "Rising Star",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Captains of the Month</h2>
            <p className="text-xl text-storm-gray">Meet our top-performing captains this month</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {topCaptains.map((captain, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group cursor-pointer"
                onClick={() => setLocation(`/captain/${captain.id}`)}
              >
                <Card className="overflow-hidden hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-2">
                  <div className="relative h-48 overflow-hidden">
                    <img
                      src={captain.image}
                      alt={captain.speciality}
                      className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300"
                    />
                    <div className="absolute top-4 left-4">
                      <Badge className="bg-yellow-400 text-yellow-900 font-semibold">{captain.badge}</Badge>
                    </div>
                  </div>
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{captain.name}</h3>
                    <p className="text-gray-600 mb-2 flex items-center">
                      <MapPin className="w-4 h-4 mr-1" />
                      {captain.location}
                    </p>
                    <p className="text-ocean-blue font-medium mb-4">{captain.speciality}</p>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <Star className="w-4 h-4 fill-yellow-400 text-yellow-400 mr-1" />
                        <span className="font-semibold">{captain.rating}</span>
                      </div>
                      <div className="text-sm text-gray-600">{captain.trips} trips completed</div>
                    </div>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              {[
                {
                  ...
                  description: "All captains are licensed, insured, and safety certified",
                },
                {
                  icon: DollarSign,
                  title: "No Hidden Fees",
                  description: "What you see is what you pay - no booking fees or commissions",
                },
                {
                  icon: Clock,
                  title: "Real-Time Booking",
                  description: "Instant availability and booking confirmation",
                },
                {
                  icon: Headphones,
                  title: "Direct Support",
                  description: "Message captains directly and get expert fishing advice",
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
            ...
            <Button size="lg" className="bg-ocean-blue hover:bg-blue-800 text-white px-8 py-4" onClick={() => setLocation("/signup")}>
              Join as a Captain
            </Button>
          </motion.div>
        </div>
